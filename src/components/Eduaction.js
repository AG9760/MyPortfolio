...
const Details = ({ type, time, place, info }) => {
  ...
  return (
    <li
      ref={ref}
      className="my-8 first:mt=0 last:mb-0 w-[60%] mx-auto flex flrx-col items-center justify-between md:w-[80%]"
    >
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
          <Details
            ...
            time="2019 - 2023"
            place="B K Birla Institute of Engineering & Technology, Pilani"
